...
export class SessionsService {
   ...
   */
  async findActiveSessionForAccess(
    sessionId: string,
    userId: string,
  ...
  async validateForRefresh(
    ...
    if (
      !this.tokenService.compareRefreshTokenHash(
        rawToken,
  ...
  rotate(
    ...
    return this.sessionsRepository.rotate(
      sessionId,
      expectedCurrentHash,
      newHash,
      newExpiresAt,
  ...
  revokeAllExcept(
    ...
    return this.sessionsRepository.revokeAllExcept(
      userId,
      keepSessionId,
      reason,
    );
